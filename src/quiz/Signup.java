...
public class Signup  extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        ImageIcon img1=new ImageIcon(ClassLoader.getSystemResource("image/image8.jpg"));
        ...
        JLabel fill = new JLabel("Create a free account now");
        fill.setBounds(100,10,300,125);
        ...
        username.setBounds(100,120,125,25);
        ...
        submit.setBackground(new Color(120,130,140));
        ...
        back.setBackground(new Color(120,130,140));
